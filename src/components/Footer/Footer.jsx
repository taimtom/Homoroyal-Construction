import brandlogo from "../../assets/images/hmlogo.png";

const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-[#011936] text-white mt-auto">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          ...
          <div className="space-y-3">
            <div className="tracking-wide uppercase text-[#e9f1f7] text-sm font-semibold">
              Social media
            </div>
      ...
      <div className="py-6 text-sm text-center dark:text-gray-600">
        &copy; {new Date().getFullYear()} Homoroyal Construction Ltd. All rights
        reserved.
      </div>
    </footer>
  );
